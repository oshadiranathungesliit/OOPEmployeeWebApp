...
public class QueryUtil extends CommonUtil {
	...
	/**
	 * This method read the SupplierQuery.xml file and retrieve the query by
	 * query id.
	 * 
	 * @param id
	 ...
	 * 
	 * @see SupplierServiceImpl#addSupplier()
	 * @see SupplierServiceImpl#createSupplierTable()
	 * @see SupplierServiceImpl#displayAllSupplier()
	 * @see SupplierServiceImpl#removeSupplier(String)
	 * 
	 */
